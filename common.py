...
def write_sent_masking_model_output(sent_with_vib):
    ###Append these sentences into a file
    sentences_sep=sent_with_vib
    if sent_with_vib is not None:
        sentences_sep=sent_with_vib.split(";")
    OUTPUT_FILE = 'TestResults_masked.csv'
    with open(OUTPUT_FILE, 'a') as file:
        for line in sentences_sep:
            file.write(line + " | ")